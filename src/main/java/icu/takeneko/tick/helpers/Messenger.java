...
public class Messenger {
    ...
    private static IChatComponent _applyStyleToTextComponent(IChatComponent comp, String style) {
        ...
        comp.getChatStyle().setItalic(style.indexOf('i') >= 0);
        comp.getChatStyle().setStrikethrough(style.indexOf('s') >= 0);
        comp.getChatStyle().setUnderlined(style.indexOf('u') >= 0);
        comp.getChatStyle().setBold(style.indexOf('b') >= 0);
        comp.getChatStyle().setObfuscated(style.indexOf('o') >= 0);
        comp.getChatStyle().setColor(EnumChatFormatting.WHITE);
        if (style.indexOf('w') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.WHITE); // not needed
        if (style.indexOf('y') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.YELLOW);
        if (style.indexOf('m') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.LIGHT_PURPLE);
        if (style.indexOf('r') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.RED);
        if (style.indexOf('c') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.AQUA);
        if (style.indexOf('l') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.GREEN);
        if (style.indexOf('t') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.BLUE);
        if (style.indexOf('f') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_GRAY);
        if (style.indexOf('g') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.GRAY);
        if (style.indexOf('d') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.GOLD);
        if (style.indexOf('p') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_PURPLE);
        if (style.indexOf('n') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_RED);
        if (style.indexOf('q') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_AQUA);
        if (style.indexOf('e') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_GREEN);
        if (style.indexOf('v') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.DARK_BLUE);
        if (style.indexOf('k') >= 0) comp.getChatStyle().setColor(EnumChatFormatting.BLACK);
        return comp;
    }
    ...
    public static IChatComponent resolve(String message, IChatComponent previous_message) {
        ...
        if (desc.charAt(0) == '/') // deprecated
        {
            if (previous_message != null)
                previous_message.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, message));
            return previous_message;
        }
        if (desc.charAt(0) == '?') {
            if (previous_message != null)
                previous_message.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, message.substring(1)));
            return previous_message;
        }
        if (desc.charAt(0) == '!') {
            if (previous_message != null)
                previous_message.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, message.substring(1)));
            return previous_message;
        }
        if (desc.charAt(0) == '^') {
            if (previous_message != null)
                previous_message.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Messenger.m(null, message.substring(1))));
            return previous_message;
        }
    ...
    public static IChatComponent m(ICommandSender receiver, Object... fields) {
        ...
        if (receiver != null)
            receiver.addChatMessage(message);
        return message;
    }
